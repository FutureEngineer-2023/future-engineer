...
## 以下是我們比較的幾種的馬達以作小車後輪動力，馬達的選擇將直接影響到小車的性能和效能。<br>馬達作為小車的核心動力來源，決定著它的速度、扭矩、能耗以及整體性能。<br>因此，了解不同種類的馬達以及它們的優缺點，對於我們在比賽中取得優勢和成就至關重要。
...
> 1.高效能：一些現代馬達設計能夠提供高效能和效率，將電能轉換為機械能，減少能源浪費。<br>
> 2.高扭矩：某些馬達能夠提供高扭矩輸出，使其適用於需要大力矩的應用。<br>
> 3.精確控制：許多馬達具有精確的控制能力，可以實現精確的運動控制和定位。<br>
> 4.長壽命：良好設計和製造質量的馬達通常具有較長的使用壽命，降低維修和更換成本。
## 缺點：

>1.成本：高性能馬達通常具有較高的成本，特別是在特殊應用或特定要求的情況下。<br>
...
>1.兼容性：EV3 Medium Servo Motor 被設計為與LEGO Mindstorms EV3系統完全兼容，因此易於集成到LEGO機器人和模型中。<br>
>2.精確度：這個馬達具有較高的精確度，可以實現精細的運動控制，可用於各種精確位置和運動要求的應用。<br>
>3.控制功能：EV3 Medium Servo Motor 具有可編程的控制功能，可以通過程式碼進行速度、轉向和位置控制，使其適用於不同的應用場景。<br>

## 缺點：

>1.功率限制：EV3 Medium Servo Motor 的功率較低，可能無法應對一些高負載或高速度要求的應用。<br>
>2.限制轉速：雖然EV3 Medium Servo Motor 的轉速範圍可調，但最大轉速相對較低，可能不適用於某些需要高速旋轉的應用。<br>
>3.限制扭矩：EV3 Medium Servo Motor 的扭矩相對較小，因此在處理大負載或需要高扭矩的應用時可能會有限制。<br>
...
>3.低功耗：GA12-N20 馬達具有較低的功耗，可節省能源並延長電池壽命。<br>
>4.高效率：該馬達通常具有較高的效率，將電能轉化為機械能時減少能量損耗。
## 缺點：
>1.轉速限制：由於尺寸小，GA12-N20 馬達的轉速通常較低，不適合高速運動應用。<br>
>2.限制扭矩輸出：儘管具有相對高的轉矩，GA12-N20 馬達的扭矩輸出仍然有限，不適合需要極高扭矩的應用。<br>
<br>
<br>

 <img high = 250 width =250 src= "https://img.shields.io/badge/⚠小結⚠ - 78C1F3" >
...
## 以下介紹我們轉向系統的設計思路、工作原理和優勢。我們將深入探討使用的控制器和機構，以及它們如何協同工作，使得小車能夠在比賽場地中輕鬆應對各種轉向挑戰。<br>我們列出了兩種方案型比較。
<br>
<br>
...
## 優點：
>1.小巧輕便：伺服馬達的體積小且重量輕，適合空間有限的應用場合。<br>
>2.高精度：伺服馬達具有相對較高的精確度和位置控制能力，適用於一些需要精確定位的應用。<br>
>3.簡單控制：伺服馬達通常只需要使用脈衝寬度調製（PWM）信號來控制，相對簡單易用。<br>
>4.相比於齒條轉向設計簡單，且誤差能減少。
## 缺點：
>1.功率限制：伺服馬達的功率輸出相對較低，適用於較小負載或低功率要求的應用。<br>
...
>7.熱關閉保護：內置熱關閉保護功能<br>
>8.內部反向極性保護二極體：內置反向極性保護二極體，以防止馬達回饋電壓對芯片造成損害。<br>
>9.尺寸：通常為20mm x 11mm x 3mm<br>

## 優點：

>1.輸入電壓範圍寬，適用於不同電源需求。<br>
>2.馬達驅動電流較高，能夠驅動較大功率的馬達。<br>
>3.具備過電流保護和熱關閉保護功能，提供額外的安全性。<br>
>4.尺寸較小，適合應用於有空間限制的項目。<br>

## 缺點：

>1.控制接口相對較少，可能不夠彈性。<br>
>2.需要額外的電阻和電容來設置PWM頻率和過電流保護閾值。<br>
>3.需要外部反向極性保護二極體，以保護芯片免受馬達回饋電壓的損害。<br>
<br>
<br>
...
## 優點：
>1.電源電壓範圍適中，適用於一般馬達應用。<br>
>2.具備過電流保護和低電壓保護功能，提供額外的安全性。<br>
>3.控制接口簡單，易於使用和集成到專案中。<br>
>4.尺寸較小，適合應用於有空間限制的項目。<br>

## 缺點：

>1.馬達驅動電流較低，不能驅動過大功率的馬達。<br>
>2.控制能力有限，無法提供高級的馬達控制功能（如步進馬達控制）。<br>
>3.需要外部反向極性保護二極體，以保護芯片免受馬達回饋電壓的損害。<br>
...
以下是L298N馬達控制板的一些基本規格和特點：
-----------------------------------------------------------------------------------------------
>1.輸入電壓：7V-35V<br>
>2.馬達驅動電流：最大2A（平均）/ 最大3A（峰值）<br>
>3.控制接口：4個輸入（IN1、IN2、IN3、IN4）和2個使能輸入（ENA、ENB）<br>
>4.馬達輸出通道：2個（可以同時控制兩個馬達）<br>
>5.控制信號類型：使用PWM信號控制速度，使用DIR信號控制轉向<br>
>6.過電流保護：內置過電流保護功能<br>
>7.過熱保護：內置過熱保護功能<br>
>8.尺寸：通常為43mm x 43mm x 27mm<br>
...
>1.輸入電壓範圍寬，適用於不同電源需求。<br>
>2.能夠提供較高的馬達驅動電流，能夠驅動較大功率的馬達。<br>
...
>2.尺寸較大，需要更多的空間來安裝和集成。<br>
>3.由於較舊的設計，效率較低，可能產生較多的熱量。<br>
<br>
<br>
 <img high = 250 width =250 src= "https://img.shields.io/badge/⚠小結⚠ -E2F6CA" >

## 由上文分析，我們選用TB6612FNG，

**原因:**

>1.電源電壓範圍：TB6612FNG的電源電壓範圍為5V-13.5V，能夠滿足2顆4.2V電池的供電需求。<br>
>2.馬達驅動電流：TB6612FNG的最大平均馬達驅動電流為1.2A，最大峰值電流為3.2A。根據N20馬達的規格，TB6612FNG可以很好地驅動GA12-N20，並提供足夠的電流。<br>
>3.控制接口：TB6612FNG具有PWM控制信號和DIR控制信號的接口，方便控制馬達的速度和轉向。<br>
...
-----------------------------------------------------------------------------------
 ...
 <img high = 250 width =250 src= "https://img.shields.io/badge/⚠小結⚠ -white" >
 
在本章節中，我們詳細描述了我們的機器移動管理，包含了馬達介紹、馬達測試與評估、驅動晶片的選擇以及底盤設計。這些步驟是實現我們自走車順利繞圈並根據顏色變化作出對應行動的關鍵。

在馬達介紹部分，我們說明了不同型號的馬達特性以及它們在自走車中的應用。透過測試和比較，我們深入了解了每種馬達的優缺點，從而能夠選擇最適合我們需求的馬達。

在進行**馬達**測試與評估時，我們對各種型號的馬達進行了多方面的測試，包括**速度、扭矩、功耗和反應時間**等。這些數據的收集和分析為我們提供了重要的參考，讓我們能夠做出明智的馬選擇，以確保自走車的運動性能和穩定性。

在**驅動晶片**的選擇中，我們考慮了各種參數如**功率、效率和可靠性**等。這些驅動晶片的選擇直接影響著馬達的控制和運動精度，因此我們精心選擇了適合我們應用的驅動晶片，以確保自走車的運動控制能夠精確且穩定。

最後，**底盤設計**是整個自走車結構的基礎。我們注重底盤的穩固性和靈活性，並學會了**3D繪圖**的技術。適當的底盤設計使得我們的自走車在比賽場地中能夠靈活移動並保持平穩的行駛。

綜合來看，在這個章節中，我們通過馬達測試和評估、驅動晶片選擇以及底盤設計，成功地構建了一個功能強大且穩定的自走車。這些細緻而周全的設計和測試過程使得我們的自走車能夠在比賽中出色表現，順利實現繞圈並根據顏色變化作出相應的轉向動作。

這次的機器移動管理的經驗對於我們整個團隊來說都是非常寶貴的。我們不僅掌握了各種移動部件的原理和運作，還學會了如何在多個選項中做出明智的選擇，以實現最佳的自走車效能。同時，我們也體會到了團隊合作的重要性，因為這些成果是我們共同努力的結晶。

在接下來的章節中，我們將繼續探討更多有關自走車的關鍵技術和成果。希望我們的報告能夠為讀者提供有價值的資訊，同時也激勵更多人參與到這個充滿挑戰又充滿樂趣的領域中。謝謝您的閱讀！
| 項目  | 數值 |
|--------|-----|
|電池電壓 |約8V |
|馬達型號| GA12-n20|
...
<img high = 150 width =150 src= "https://img.shields.io/badge/電源 -E8FFCE" > 


| 電池類型 | 電池化學  | 電池容量  | 電壓  | 尺寸   | 重量  | 放電率 | 優點  | 缺點 |
|---------|----------|-----------|--------|------|------|-------|-------|------|
| LiFePO4電池   | 
![image](https://github.com/yy0106yy/future-engineer/blob/main/%E9%9B%BB%E6%BA%90%E5%92%8C%E6%84%9F%E6%B8%AC%E5%99%A8%E7%AE%A1%E7%90%86/lifepo%E9%9B%BB%E6%B1%A0.jpg)  | 鋰鐵磷酸鋰 | 較大         | 3.2V   | 可變化，較大尺寸   | 較重        | 較穩定         |  相對安全 - 較高的循環壽命 - 高放電率        |  較昂貴  較大尺寸                                                                                                                                                                                                                                                                         |
| 18650鋰電池    |
![image](https://github.com/yy0106yy/future-engineer/blob/main/%E9%9B%BB%E6%BA%90%E5%92%8C%E6%84%9F%E6%B8%AC%E5%99%A8%E7%AE%A1%E7%90%86/18650%E9%8B%B0%E9%9B%BB%E6%B1%A0.jpg)| 鋰離子     | 多種容量選擇 | 3.7V   | 直徑18mm，長度65mm | 較重        | 較高           |  廣泛使用，容易購得 - 各種容量可供選擇  較高放電率                                                                                                                                                                                            |  相對較大和較重 - 可能需要更多電池以達到所需電源                                                                                                                                                                                                                                            |
| 14500鋰電池     |
![image](https://github.com/yy0106yy/future-engineer/blob/main/%E9%9B%BB%E6%BA%90%E5%92%8C%E6%84%9F%E6%B8%AC%E5%99%A8%E7%AE%A1%E7%90%86/%E9%8B%B0%E9%9B%BB%E6%B1%A0%E5%9C%96%E7%89%87.jpg)| 鋰離子     | 較小         | 3.7V   | 直徑14mm，長度50mm | 較輕  | 較高    | 輕巧，適合尺寸有限的應用 - 較高的能量密度     |  容量較小，使用時間較短  不適合高功率設備  市場上較罕見                                                                                                                                                                                                                             

<br>
<br>

### 由上表分析我們選擇14500的原因
>1.**小型輕巧**：14500鋰電池相對於其他選項尺寸更小且輕巧。這對於放置在自製的小車中尺寸有限的情況下非常合適，有助於減少整體重量和體積。<br>
>2.**高能量密度**：儘管14500電池容量相對較小，但它們仍然具有較高的能量密度。這意味著它們可以提供足夠的電量來驅動小型車輛，同時保持輕量化和小巧化的優勢。<br>
>3.**適用於輕負載應用**：車子不需要高功率，而是適合輕負載應用，14500鋰電池是一個合理的選擇。<br>
<br>

### 以下為我們的配置
**數量** :2顆。<br>
**電壓** :3.7伏特（V）。(1顆)<br>
**容量** :14500 鋰電池的容量通常在800毫安時（mAh）至1200毫安時（mAh）之間。(1顆)<br>
**重量** :20克至30克。<br>
...
**LM2596S**這是一種高效的穩壓器，其輸出電壓通過控制開關元件（通常是MOSFET）的開關時間來實現。切換穩壓器使用週期性的開關操作，**將輸入電壓轉換成一個間斷的脈衝**，然後通過適當的過濾和調節電路轉換為穩定的輸出電壓。儘管切換穩壓器的成本較高，但由於其高效性，廣泛應用於許多範圍的電源應用中。

### 原本我們採用了LM2596S這顆穩壓器，但後來我們主控板上的穩壓器已有**AMS117**、**78m05**這兩個穩壓器而且它足以應付我們的電壓，還能夠節省空間。
<br>
<br>
<br>
...
| 顏色感應器模組                | 通信介面   | 可測量光譜                     | 特點                                                         |
| ---------------------------- | ---------- | ------------------------------ | ------------------------------------------------------------ |
| **Adafruit TCS34725**       |
![image](https://github.com/yy0106yy/future-engineer/blob/main/%E9%9B%BB%E6%BA%90%E5%92%8C%E6%84%9F%E6%B8%AC%E5%99%A8%E7%AE%A1%E7%90%86/%E9%A1%8F%E8%89%B2%E6%84%9F%E6%87%89%E5%99%A8/tcs34725.jpg)| I2C        | 紅、綠、藍、透明                | 高精度的顏色感測，支援IR封包消除，具有額外的透明度測量功能   |
| **BH1749NUC RGB and IR Sensor** |
![image](https://github.com/yy0106yy/future-engineer/blob/main/%E9%9B%BB%E6%BA%90%E5%92%8C%E6%84%9F%E6%B8%AC%E5%99%A8%E7%AE%A1%E7%90%86/%E9%A1%8F%E8%89%B2%E6%84%9F%E6%87%89%E5%99%A8/BH1749NUC.jpg)| I2C        | 紅、綠、藍、紅外線              | 測量可見光和紅外光譜，適用於需要多光譜信息的應用             |
| **Adafruit VEML7700 Lux Sensor** |
![image](https://github.com/yy0106yy/future-engineer/blob/main/%E9%9B%BB%E6%BA%90%E5%92%8C%E6%84%9F%E6%B8%AC%E5%99%A8%E7%AE%A1%E7%90%86/%E9%A1%8F%E8%89%B2%E6%84%9F%E6%87%89%E5%99%A8/VEML7700.jpg)| I2C        | 紅、綠、藍                     | 環境光和顏色感測，可同時測量光照強度，適用於調節背光等應用 |
| **TCS3200 Color Sensor**  |
![image](https://github.com/yy0106yy/future-engineer/blob/main/%E9%9B%BB%E6%BA%90%E5%92%8C%E6%84%9F%E6%B8%AC%E5%99%A8%E7%AE%A1%E7%90%86/%E9%A1%8F%E8%89%B2%E6%84%9F%E6%87%89%E5%99%A8/TCS3200.jpg)| 數位輸出   | 紅、綠、藍                     | 廉價但功能強大，具有可調光敏度和輸出頻率                     |

### 選擇：<br>
<img high = 150 width =150 src= "https://img.shields.io/badge/TCS34725 -468B97" > 

### 原因：<br>
>1.**高精度的顏色感測**：TCS34725 提供高精度的顏色感測，可識別紅、綠、藍和透明色彩，這在辨識場地上的顏色是非常有用的。<br>
>2.**支援IR封包消除**：TCS34725 支援IR封包消除功能，可以消除紅外干擾，確保測量結果更準確。<br>
>3.**廣泛應用性**：TCS34725 可以應用於色彩辨識、顏色測量和環境光應用等場景，非常適合在玩具小車上用於偵測場地顏色。<br>
...
## 功耗
**待機模式**（Standby Mode）功耗：約2.5微安（μA）。<br>
**運行模式**（Active Mode）功耗：取決於工作條件和設置，一般在10-15毫安（mA）範圍內。<br>
## 用途
**我們運用顏色感應器來知道何時到了轉角，並且從地上的橘線跟藍線判斷此時應該要順時鐘轉還是逆時鐘繞圈。**
<br>

--------------------------------------------------------------------------------------------------------------------

<br>
<img high = 250 width =250 src= "https://img.shields.io/badge/陀螺儀感應器 -EF6262" > 

<img high = 150 width =150 src= "https://img.shields.io/badge/MPU6050 -EF6262" >


<br>
<br>

![image](https://github.com/yy0106yy/future-engineer/blob/main/%E9%9B%BB%E6%BA%90%E5%92%8C%E6%84%9F%E6%B8%AC%E5%99%A8%E7%AE%A1%E7%90%86/%E9%99%80%E8%9E%BA%E5%84%80%E6%84%9F%E6%87%89%E5%99%A8/%E9%99%80%E8%9E%BA%E5%84%80%E6%84%9F%E6%87%89%E5%99%A8MPU6050.jpg)

## 功耗
**待機模式**（Standby Mode）功耗：約10微安（μA）。<br>
**運行模式**（Active Mode）功耗：取決於數據更新率和操作條件，一般在3.5-6.5毫安（mA）範圍內。<br>

## 用途
**我們使用陀螺儀感應器來矯正我們的轉向，並以程式編寫，達到輸入一個角度，機器就可以自動轉向該方位。**
...
<img high = 250 width =250 src= "https://img.shields.io/badge/視覺感應器 -F3AA60" > 

<img high = 150 width =150 src= "https://img.shields.io/badge/ESP32 cam -F3AA60" > 

![image](https://github.com/yy0106yy/future-engineer/blob/main/%E9%9B%BB%E6%BA%90%E5%92%8C%E6%84%9F%E6%B8%AC%E5%99%A8%E7%AE%A1%E7%90%86/%E6%94%9D%E5%BD%B1%E6%A9%9F/%E6%94%9D%E5%BD%B1%E6%A9%9FESP32.jpg)

## 功耗
**開啟閃光燈並且亮度調到最大**:約310mA。<br>
**Deep-sleep**:最低功耗可以達到 6mA。<br>

## 用途
**我們使用視覺感應器來觀測障礙物的顏色、方位、距離，達到閃障礙的目的**

--------------------------------------------------------------------------------------------------------------------

 <img high = 250 width =250 src= "https://img.shields.io/badge/⚠小結⚠ -white" >
 
在感應器及電源應用與腳位接法的篇章中，我們深入探討了顏色感應器、陀螺儀感應器和視覺感應器的應用及相關數據。這些感應器在我們的比賽自走車中扮演著關鍵的角色，使得車子能夠實現在正方形框中繞圈並根據顏色變化執行相應的轉向動作。以下是我們對於這些感應器及電源應用的結論：

1.**顏色感應器的應用：**
<br>
>顏色感應器在自走車中的應用非常重要。我們利用顏色感應器來偵測正方形框內的綠色和紅色柱子，並根據顏色變化來控制車子的轉向。<br>
>透過精確的顏色辨識，我們的車子能夠準確地執行左轉和右轉的動作，確保在比賽中達到最佳表現。<br>
<br>

2.**陀螺儀感應器的應用：**
<br>

>陀螺儀感應器在自走車中扮演著重要的角色，幫助我們實現穩定的行駛。這個感應器能夠感知車子朝向的方位，讓我們能夠及時調整馬達的功率和方向，使車子保持直線並避免偏移。<br>
>這對於在繞圈過程中保持穩定性和精確性至關重要，確保我們的自走車能夠順利完成比賽任務。<br>
<br>

3.**視覺感應器的應用：**
<br>

>視覺感應器是我們自走車中的眼睛，能夠實時捕捉周圍環境的影像。這使得我們的車子能夠更智能地適應不同場景和環境，提供更靈活、準確的響應。<br>
>透過視覺感應器，我們能夠更好地理解比賽場地，更靈活地應對環境變化，從而提高自走車的效率和競爭力。<br>

<br>
在篇章中，我們深入討論了這些感應器的數據、特性以及在自走車中的應用，並通過實際測試驗證了它們的有效性。這些感應器的成功應用使得我們的自走車能夠在比賽中表現出色，並取得優異的成績。這也為我們日後在自走車相關領域的研究和應用提供了寶貴的經驗和啟示。<br>
<br>
