...
在進行馬達測試與評估時，我們對各種型號的馬達進行了多方面的測試，包括速度、扭矩、功耗和反應時間等。這些數據的收集和分析為我們提供了重要的參考，讓我們能夠做出明智的馬選擇，以確保自走車的運動性能和穩定性。

在驅動晶片的選擇中，我們考慮了各種參數如功率、效率和可靠性等。這些驅動晶片的選擇直接影響著馬達的控制和運動精度，因此我們精心選擇了適合我們應用的驅動晶片，以確保自走車的運動控制能夠精確且穩定。

最後，底盤設計是整個自走車結構的基礎。我們注重底盤的穩固性和靈活性，以應對各種不同的地形和環境。適當的底盤設計使得我們的自走車在比賽場地中能夠靈活移動並保持平穩的行駛。
...
<img high = 150 width =150 src= "https://img.shields.io/badge/14500鋰電池 -E8FFCE" > 
...
1.**顏色感應器的應用：**
顏色感應器在自走車中的應用非常重要。我們利用顏色感應器來偵測正方形框內的綠色和紅色柱子，並根據顏色變化來控制車子的轉向。透過精確的顏色辨識，我們的車子能夠準確地執行左轉和右轉的動作，確保在比賽中達到最佳表現。<br>
<br>
2.**陀螺儀感應器的應用：**
陀螺儀感應器在自走車中扮演著重要的角色，幫助我們實現穩定的行駛。這個感應器能夠感知車子朝向的方位，讓我們能夠及時調整馬達的功率和方向，使車子保持直線並避免偏移。這對於在繞圈過程中保持穩定性和精確性至關重要，確保我們的自走車能夠順利完成比賽任務。<br>
<br>
3.**視覺感應器的應用：**
視覺感應器是我們自走車中的眼睛，能夠實時捕捉周圍環境的影像。這使得我們的車子能夠更智能地適應不同場景和環境，提供更靈活、準確的響應。透過視覺感應器，我們能夠更好地理解比賽場地，更靈活地應對環境變化，從而提高自走車的效率和競爭力。<br>
<br>
...
總而言之，我們的感應器及電源應用的篇章是本次報告中重要的一部分，通過對顏色感應器、陀螺儀感應器和視覺感應器的深入研究，我們成功實現了自走車的精確控制和穩定運行。這些感應器的應用不僅提升了我們自走車的性能，同時也拓展了我們對於自動控制和感應技術的認識和應用能力。<br>
 ...
 <br>
# 障礙管理
我們討論的程式包含了如何精準的**繞正方形場地**與**分辨障礙物做出相應的閃躲動作**

**繞正方形的策略**我們使用了陀螺儀並做一個副程式來幫助我們可以快速且變得使用。<br>

首先因為MPU6050的回傳值是0~360度，為了讓我們方便計算，必須把值轉成正負180。<br>
轉換的程式如下:
